...
def main() -> int:
    ...
    try:
        ...
        _gather_bsp_name = gather_parser.add_argument(
            "bsp_name",
            nargs="?",
            type=str,
        ...
        _gather_bsp_name.completer = BspNameCompleter()
